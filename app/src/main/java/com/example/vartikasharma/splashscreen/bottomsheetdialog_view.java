...
public class bottomsheetdialog_view extends BottomSheetDialog implements View.OnClickListener {
    ...
    private static bottomsheetdialog_view instance;

    public static bottomsheetdialog_view getInstance(@NonNull Context context) {
        return instance == null ? new bottomsheetdialog_view(context) : instance;
    }

    public bottomsheetdialog_view(@NonNull Context context) {
        super(context);
